...
WebUI.setText(findTestObject('Registerpage/Birthday_in'), '19/09/2545')
...
WebUI.verifyElementNotClickable(findTestObject('Registerpage/invoice_name'), FailureHandling.STOP_ON_FAILURE)
